    ...
    <form action="{{route('asing.update', $asing)}}" method='POST'>
        ...
        <div class="form-group col-md-6">
            ...
            <select id="inputState" class="form-control" name="language">
              <option value="{{$asing->language}}">{{$asing->language}}</option>
          ...
          <div class="form-group col-md-6">
            ...
            <select id="inputState" class="form-control" name="speaking">
              <option value="{{$asing->speaking}}">{{$asing->speaking}}</option>
          ...
          <div class="form-group col-md-6">
            ...
            <select id="inputState" class="form-control" name="reading">
              <option value="{{$asing->reading}}">{{$asing->reading}}</option>
              <option value="Sangat Baik">Sangat Baik</option>
          ...
          <div class="form-group col-md-6">
            ...
            <select id="inputState" class="form-control" name="writing">
              <option value="{{$asing->writing}}">{{$asing->writing}}</option>
              <option value="Sangat Baik">Sangat Baik</option>
